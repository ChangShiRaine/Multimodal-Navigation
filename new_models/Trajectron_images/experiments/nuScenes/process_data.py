...
train = \
    ['scene-0700', 'scene-0789', 'scene-0179', 'scene-1108', 'scene-0041', 'scene-0533', 'scene-0718', 'scene-0185',
     'scene-0871', 'scene-0402', 'scene-0255', 'scene-0138', 'scene-0671', 'scene-0379', 'scene-1081', 'scene-0736',
     'scene-0644', 'scene-0120', 'scene-0645', 'scene-0042', 'scene-0529', 'scene-0668', 'scene-0244', 'scene-0348',
     'scene-1100', 'scene-0738', 'scene-0747', 'scene-0895', 'scene-0417', 'scene-0252', 'scene-1086', 'scene-0202',
     'scene-0435', 'scene-0998', 'scene-0139', 'scene-0151', 'scene-0350', 'scene-0397', 'scene-1009', 'scene-0976',
     'scene-0875', 'scene-0074', 'scene-0660', 'scene-0804', 'scene-0356', 'scene-0395', 'scene-0010', 'scene-0678',
     'scene-0227', 'scene-0666', 'scene-0284', 'scene-0884', 'scene-1017', 'scene-0894', 'scene-0420', 'scene-0546',
     'scene-0421', 'scene-0317', 'scene-0424', 'scene-0301', 'scene-0021', 'scene-0988', 'scene-0203', 'scene-1058',
     'scene-0174', 'scene-0575', 'scene-1022', 'scene-0347', 'scene-0155', 'scene-1006', 'scene-0583', 'scene-0430',
     'scene-0232', 'scene-0359', 'scene-0657', 'scene-0433', 'scene-0298', 'scene-0532', 'scene-1099', 'scene-0019']

val = \
    ['scene-0370', 'scene-0949', 'scene-1051', 'scene-1098', 'scene-0161', 'scene-0821', 'scene-0303', 'scene-0034',
     'scene-0961', 'scene-1004']

test = \
    ['scene-0110', 'scene-0552', 'scene-0926', 'scene-1060', 'scene-0100', 'scene-0911', 'scene-0637', 'scene-0097',
     'scene-0522', 'scene-0564']
...
def process_scene(ns_scene, env, nusc, data_path):
    ...
    while sample['next']:
        ...
        scene_sample_tokens.append(sample_data['sample_token'])
    ...
    scene.scene_sample_tokens = scene_sample_tokens
...
def process_data(data_path, version, output_path, val_split):
    ...
    #reduced sets
    ns_scene_names['train'] = train
    ns_scene_names['val'] = val
    ns_scene_names['test'] = test
