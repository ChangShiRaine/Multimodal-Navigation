...
class Trajectron(object):
    ...
    def train_loss(self, batch, node_type):
        ...
        if type(front_camera_images) == torch.Tensor:
            front_camera_images = front_camera_images.to(self.device)
        ...
        loss = model.train_loss(inputs=x,
                                ...
                                map=map,
                                image_seqs= front_camera_images,
    ...
    def predict(self,
        ...
        for node_type in self.env.NodeType:
            ...
            batch = get_timesteps_data(env=self.env, scene=scene, t=timesteps, node_type=node_type, state=self.state,
                                       ...
                                       max_ft=min_future_timesteps, hyperparams=self.hyperparams, nuscenes_dataset = nuscenes_dataset)
            ...
            (first_history_index,
             ...
             neighbors_edge_value,
             robot_traj_st_t,
             map, front_camera_images), nodes, timesteps_o = batch
